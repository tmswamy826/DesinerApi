...
using EzPassService.ServiceId.AuthorizeUser;
using EzPassService.ServiceId.LoginUser;
...
{
    /// <summary>
    /// ServiceId Class used by all other EzPass service calls
    /// Purpose is to authenticate using the user's token and grab a serviceId from EzPass
    /// Extends ServiceClient for Http Requests
    /// </summary>
